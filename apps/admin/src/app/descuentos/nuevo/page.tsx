...
export default function NuevoDescuentoPage() {
  ...
  return (
    <main style={{ padding: '1.5rem', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: '#64748b', margin: '0.2rem 0 0 0' }}>
              Configura las reglas de la promoción y simula el impacto en tiempo real
            </p>
          </div>
        </div>
      </header>
      ...
      {loading ? (
        <p style={{ textAlign: 'center', color: '#64748b', padding: '3rem 0' }}>Cargando catálogo...</p>
      ) : (
        <DiscountForm
