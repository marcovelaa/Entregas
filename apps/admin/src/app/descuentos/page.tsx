                      ...
                      <tr key={d.id}>
                        ...
                        <td>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <span style={{ fontWeight: 600 }}>{d.usosActuales}</span>
                            <span style={{ color: '#94a3b8' }}>/ {d.limiteUsos ? d.limiteUsos : '∞'}</span>
                          </div>
                          {d.limiteUsos && d.limiteUsos > 0 && (
                            <div style={{ width: '60px', height: '4px', backgroundColor: '#e2e8f0', borderRadius: '2px', marginTop: '4px', overflow: 'hidden' }}>
                              <div style={{ width: `${Math.min(100, (d.usosActuales / d.limiteUsos) * 100)}%`, height: '100%', backgroundColor: '#0f172a' }} />
                            </div>
                          )}
                        </td>
                        <td>
