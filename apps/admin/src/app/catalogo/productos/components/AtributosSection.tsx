...
export default function AtributosSection({ productPayload, setProductPayload, categorias, selectedNaturaleza }: Props) {
    ...
    return (
      <div className={styles.formGrid}>
        ...
        {atributos.nivel === 'Inicial' && (
          <div className={styles.formGroup}>
            <label className={styles.formLabel}>Sub-Nivel</label>
            <select className={styles.formSelect} value={atributos.subnivel || ''} onChange={e => updateAttr('subnivel', e.target.value)}>
        ...
        <div className={styles.formGroup}>
          ...
          <input className={styles.formInput} placeholder="Ej. Bicentenario" value={atributos.serie || ''} onChange={e => updateAttr('serie', e.target.value)} />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Materia</label>
          <input className={styles.formInput} placeholder="Ej. Matemáticas" value={atributos.materia || ''} onChange={e => updateAttr('materia', e.target.value)} />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Autor(es)</label>
          <input className={styles.formInput} placeholder="Ej. García Márquez" value={atributos.autor || ''} onChange={e => updateAttr('autor', e.target.value)} />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>ISBN</label>
          <input className={styles.formInput} placeholder="ISBN del libro" value={atributos.isbn || ''} onChange={e => updateAttr('isbn', e.target.value)} />
        </div>
        <div className={`${styles.formGroup} ${styles.formGridFull}`}>
          <label className={styles.checkboxRow}>
            <input type="checkbox" checked={atributos.es_plan_lector || false} onChange={e => updateAttr('es_plan_lector', e.target.checked)} />
    ...
    return (
      <div className={styles.formGrid}>
        <div className={styles.formGroup}>
          ...
          <select className={styles.formSelect} value={atributos.tamano || ''} onChange={e => updateAttr('tamano', e.target.value)}>
            <option value="">Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          ...
          <select className={styles.formSelect} value={atributos.tipo_tapa || ''} onChange={e => updateAttr('tipo_tapa', e.target.value)}>
            <option value="">Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          ...
          <input type="number" className={styles.formInput} placeholder="Ej. 100" value={atributos.cantidad_hojas || ''} onChange={e => updateAttr('cantidad_hojas', e.target.value)} />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Tipo de Hojas</label>
          <select className={styles.formSelect} value={atributos.tipo_hojas || ''} onChange={e => updateAttr('tipo_hojas', e.target.value)}>
            <option value="">Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Tipo de Anillado</label>
          <select className={styles.formSelect} value={atributos.tipo_anillado || ''} onChange={e => updateAttr('tipo_anillado', e.target.value)}>
            <option value="">Seleccionar...</option>
    ...
    return (
      <div className={styles.formGrid}>
        <div className={`${styles.formGroup} ${styles.formGridFull}`}>
          ...
          <select className={styles.formSelect} value={atributos.tipo_articulo || ''} onChange={e => {
        ...
        {isEscritura && (
          <>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Punta / Trazo</label>
              <select className={styles.formSelect} value={atributos.tamano_punta || ''} onChange={e => updateAttr('tamano_punta', e.target.value)}>
                <option value="">Seleccionar...</option>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Composición de Tinta</label>
              <select className={styles.formSelect} value={atributos.tipo_tinta || ''} onChange={e => updateAttr('tipo_tinta', e.target.value)}>
                <option value="">Seleccionar...</option>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Color de Tinta</label>
              <input className={styles.formInput} placeholder="Ej. Azul, Rojo, Negro, Surtido" value={atributos.color || ''} onChange={e => updateAttr('color', e.target.value)} />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Forma del Cuerpo</label>
              <select className={styles.formSelect} value={atributos.forma_cuerpo || ''} onChange={e => updateAttr('forma_cuerpo', e.target.value)}>
                <option value="">Seleccionar...</option>
        ...
        {isLapices && (
          <>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Graduación / Dureza (Lápiz negro)</label>
              <select className={styles.formSelect} value={atributos.graduacion || ''} onChange={e => updateAttr('graduacion', e.target.value)}>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Cantidad de Colores (Set)</label>
              <select className={styles.formSelect} value={atributos.cantidad_colores || ''} onChange={e => updateAttr('cantidad_colores', e.target.value)}>
        ...
        {isAdhesivos && (
          <>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Tipo de Adhesivo</label>
              <select className={styles.formSelect} value={atributos.tipo_adhesivo || ''} onChange={e => updateAttr('tipo_adhesivo', e.target.value)}>
                <option value="">Seleccionar...</option>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Contenido / Medida</label>
              <input className={styles.formInput} placeholder="Ej. 40g, 100ml, 12mm x 10m" value={atributos.medida || ''} onChange={e => updateAttr('medida', e.target.value)} />
            </div>
          </>
        )}
        ...
        {isGeometria && (
          <>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Instrumento</label>
              <select className={styles.formSelect} value={atributos.instrumento || ''} onChange={e => updateAttr('instrumento', e.target.value)}>
                <option value="">Seleccionar...</option>
            ...
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Tamaño / Longitud</label>
              <input className={styles.formInput} placeholder="Ej. 20cm, 30cm" value={atributos.medida || ''} onChange={e => updateAttr('medida', e.target.value)} />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Material</label>
              <select className={styles.formSelect} value={atributos.material || ''} onChange={e => updateAttr('material', e.target.value)}>
                <option value="">Seleccionar...</option>
        ...
        {atributos.tipo_articulo && (
          <>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Características Extra</label>
              <input className={styles.formInput} placeholder="Ej. No tóxico, Lavable, Retráctil" value={atributos.caracteristicas || ''} onChange={e => updateAttr('caracteristicas', e.target.value)} />
            </div>
            <div className={styles.formGroup}>
              <label className={styles.formLabel}>Presentación Base</label>
              <select className={styles.formSelect} value={atributos.presentacion || ''} onChange={e => updateAttr('presentacion', e.target.value)}>
                <option value="">Seleccionar...</option>
  ...
  if (selectedNaturaleza === 'Papelería' || selectedNaturaleza === 'Papeles') {
    return (
      <div className={styles.formGrid}>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Tipo de Papel / Material *</label>
          <select className={styles.formSelect} value={atributos.tipo_papel || ''} onChange={e => updateAttr('tipo_papel', e.target.value)}>
            <option value="">Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Tamaño / Formato</label>
          <select className={styles.formSelect} value={atributos.tamano || ''} onChange={e => updateAttr('tamano', e.target.value)}>
            <option value="">Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Gramaje (Grosor)</label>
          <select className={styles.formSelect} value={atributos.gramaje || ''} onChange={e => updateAttr('gramaje', e.target.value)}>
            <option value="">No aplica / Seleccionar...</option>
        ...
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Color / Diseño</label>
          <input className={styles.formInput} placeholder="Ej. Blanco, Colores Pastel, Estampado" value={atributos.color || ''} onChange={e => updateAttr('color', e.target.value)} />
        </div>
        <div className={styles.formGroup}>
          <label className={styles.formLabel}>Presentación (Empaque)</label>
          <select className={styles.formSelect} value={atributos.presentacion || ''} onChange={e => updateAttr('presentacion', e.target.value)}>
            <option value="">Seleccionar...</option>
